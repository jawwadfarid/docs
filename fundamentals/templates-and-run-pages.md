...
Pick a template that fits a real use case in your workflow.&#x20;
...
Your automation will run and deliver your output.
...
* "Change the output format to a PDF report"
* "Add trend analysis to this workflow"&#x20;
