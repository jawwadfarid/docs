...
## How different people are using Person Finder within their day to day workflows

<table data-view="cards"><thead><tr><th></th><th></th></tr></thead><tbody><tr><td><h4>Sales &#x26; Biz Dev Teams</h4></td><td>Quickly research prospects to personalize outreach using verified profiles and recent activity + prep for calls with warm leads.</td></tr><tr><td><h4>Recruiters</h4></td><td>Get a full view of candidates—career history, social presence, skills—at a glance before interviews.</td></tr><tr><td><h4>Founders &#x26; Execs</h4></td><td>Prep for meetings with partners, investors, or hires by scanning clean, contextual profiles in seconds.</td></tr><tr><td><h4>VCs &#x26; Analysts</h4></td><td>Understand founders and team dynamics quickly before intro calls or diligence.</td></tr><tr><td><h4>Content Creators &#x26; Journalists</h4></td><td>Pull together accurate bios and context on people you’re featuring, interviewing, or referencing.</td></tr><tr><td><h4>User Researchers &#x26; Product Teams</h4></td><td>Prep for interviews with rich context on participants—background, posts, skills—without manual searching.</td></tr></tbody></table>
...
{% stepper %}
{% step %}
### Go to the [Person Finder Workflow](https://codewords.agemo.ai/run/person_finder) on Codewords
{% endstep %}

{% step %}
### Complete your set up&#x20;

Download the CodeWords Chrome Extension.&#x20;
...
{% stepper %}
{% step %}
### Go to the [Person Finder from Slack Workflow](https://codewords.agemo.ai/run/person_finder) on CodeWords
...
Add in the name of the name of the channel where you want to use Person Finder. You don't have to include the hashtag in front of the name of the channel.&#x20;
{% endstep %}
...
2. **Start using the workflow**
   * Simply mention a person's name along with additional information in your channel
   * For example:
     ...
     * "Need to contact Sarah Johnson, a product designer based in San Francisco"
...
Reach out to us at support@agemo.ai, or if you're a beta user, get in touch with one of our team members on Slack.
